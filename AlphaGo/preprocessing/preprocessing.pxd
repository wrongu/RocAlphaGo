...
ctypedef int (*preprocess_method)(Preprocess, GameState, tensor_type[:, ::1], char*, int)  # noqa: E501
...
cdef class Preprocess:
    ...
    """A feature wrapping GameState.is_ladder_escape(). Check if player_current group can escape
       ladder
    """
